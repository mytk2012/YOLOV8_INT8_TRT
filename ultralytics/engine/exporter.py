...
from ultralytics.engine.calibrator import Calibrator
...
class Exporter:
    ...
    def export_engine(self, prefix=colorstr('TensorRT:')):
        ...
        #修改
        f_onnx = "/home/FastSAM-main/ultralytics/model_Log/FP32/yolov8n.onnx"
        
        LOGGER.info(f'\n{prefix} starting export with TensorRT {trt.__version__}...')
        assert Path(f_onnx).exists(), f'failed to export ONNX file: {f_onnx}'
        # f = self.file.with_suffix('.engine')  # TensorRT engine file
        #修改
        f="/home/FastSAM-main/ultralytics/int8/weights/yolov8.engine"
...
#
        ...
        # shape = self.im.shape
        # print("inp.name:",inp.name," [1]:",(1, *shape[1:])," [2]:",(max(1, shape[0] // 2), *shape[1:])," [3]:",shape)
        ...
        #
        # if builder.platform_has_fast_fp16 and self.args.half:  #判断是否支持16位
        ...
        img_height = 640
        img_wdith = 640
        calibration_images = "/home/pick_data"
        calibration_cache = "/home/FastSAM-main/ultralytics/int8/weights/yolov8_calibration.cache"
        print("int8转换开始 本地")
        ...
        with builder.build_engine(network, config) as engine, open(f, 'wb') as t:
            ...
            t.write(len(meta).to_bytes(4, byteorder='little', signed=True)) # len(meta) 这个整数值表示为一个 4 字节的字节序列，使用小端序，可以在数据传输或存储时将长度信息编码成字节序列
            t.write(meta.encode())
            # Model
